	...
	.dataTable(
			{
				...
				"sScrollXInner": "100%",
				"width" : "10px",
				"sAjaxSource" : "json/yavni/bank?action=inventory&bankId="+bankID,
				"aoColumns" : [ {
	...
	.dataTable(
			{
				...
				"bServerSide": false,
				"width" : "10px",
				"sAjaxSource" : "json/yavni/bank?action=loadVerifiable&bankId="+bankID,
				"aoColumns" : [ {
					"mData" : "id"
				}, {
					"mData" : "batch"
	...
	.dataTable(
			{
				...
				"bServerSide": false,
				"width" : "10px",
				"sAjaxSource" : "json/yavni/bank?action=allInventories&bankId="+bankID,
				"aoColumns" : [ {
					"mData" : "id"
				}, {
					"mData" : "batch"
...
.dataTable(
		{
			...
			"bServerSide": false,
			"width" : "10px",
			"sAjaxSource" : "json/yavni/bank?action=loadApprovable?bankId="+bankID,
			"aoColumns" : [ {
				"mData" : "id"
			}, {
				"mData" : "batch"
